...
public class main {
    public static void main(String[] args) {
        Cliente cliente = new Cliente(null, "Matheus", "matheus@gmail.com", "5555555", Criptografar.encryp("123"), true, null, null );
        ClienteDao clienteDao = new ClienteDao();
              clienteDao.save(cliente);

        Gerente g = new Gerente(null, "Bruno", "bruno@gmail.com", "111", Criptografar.encryp("123"),true, null, null);
